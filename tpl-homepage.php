...
<div class="home-slider">
	<div id="slider" class="sl-slider-wrapper">
		...
		<nav id="nav-arrows" class="nav-arrows">
			<span class="nav-arrow-prev"><?php echo __('Previous','aweber'); ?></span>
			<span class="nav-arrow-next"><?php echo __('Next','aweber'); ?></span>
		</nav>
	</div><!-- /slider-wrapper -->
</div><!-- home-slider -->
<?php endif; ?>
<div class="feature-text-area">
	<div class="container">
		<h3><?php echo (aweber_setting('aweber_hometext') !='' ? sanitize_text_field( aweber_setting('aweber_hometext') ) : ''); ?></h3>
	</div><!-- container -->
			...
			<div class="port-image">
				<?php
					if ( 'video' == get_post_format( get_the_ID() ) ) :
	 					...
	 					echo aweber_get_video( get_the_ID() );
				...
				?>
					<div class="blog-post-box <?php echo (is_sticky() ? 'sticky-post': ''); ?>">
						...
						<div class="blog-post-info">
							<h3><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
							<div class="blog-post-meta"> <?php the_time(get_option('date_format') ); ?> | <a href="<?php comments_link(); ?>"><?php  comments_number( __('0 Comments','aweber'), __(' 1 Comment','aweber'), '% '.__('Comments','aweber') ); ?></a></div>
